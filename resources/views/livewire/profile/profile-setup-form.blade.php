<div class="bg-white p-6 rounded-lg shadow-sm">
    <div class="max-w-xl">
        <h3 class="text-lg font-semibold text-gray-80 mb-4">Configuración de Perfil</h3>
        ...
        <form wire:submit="saveProfile" class="space-y-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h4 class="text-md font-medium text-gray-800 mb-4">Información Personal</h4>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-3 py-2 border border-gray-30 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-50"
                            required
                        />
                    ...
                    <div class="md:col-span-2">
                        <label for="profession" class="block text-sm font-medium text-gray-70 mb-1">Profesión</label>
                        <input 
                            type="text" 
                            id="profession" 
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h4 class="text-md font-medium text-gray-800 mb-4">Información de Logia</h4>
