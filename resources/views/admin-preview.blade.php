...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-6">
        <div class="bg-white p-6 rounded-lg shadow-sm stat-card flex justify-between items-center">
            ...
            <div class="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-500"><i class="ri-group-2-line text-2xl"></i></div>
        </div>
        <div class="bg-white p-6 rounded-lg shadow-sm stat-card flex justify-between items-center">
            <div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm">
                ...
                <ul class="divide-y divide-gray-200">
                    <li class="py-4 flex items-center">
                        ...
                        <div class="flex-1">
                            <p class="text-sm">Nuevo documento <a href="#" class="font-medium text-indigo-500">"Plancha de Arquitectura"</a> fue subido.</p>
                    ...
                    <li class="py-4 flex items-center">
                        ...
                        <div class="flex-1">
                            <p class="text-sm">Nuevo miembro <a href="#" class="font-medium text-indigo-500">Juan Perez</a> fue aprobado.</p>
                    ...
                    <li class="py-4 flex items-center">
                        ...
                        <div class="flex-1">
                            <p class="text-sm">Nuevo evento <a href="#" class="font-medium text-indigo-500">"Tenida de Solsticio"</a> fue programado.</p>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2.5">
                            <div class="bg-indigo-500 h-2.5 rounded-full" style="width: 87.5%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between text-sm mb-1">
