...
@section('content')
    ...
    <div class="mb-6 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500">
            <li class="mr-2">
                <a href="#" class="inline-flex items-center justify-center p-4 border-b-2 border-green-500 text-green-600 rounded-t-lg active group font-semibold" data-tab="published">
                    <i class="ri-check-double-line mr-2"></i>Publicadas ({{ $published->count() }})
                </a>
            </li>
            <li class="mr-2">
                <a href="#" class="inline-flex items-center justify-center p-4 border-b-2 border-yellow-500 text-yellow-600 rounded-t-lg group font-semibold" data-tab="drafts">
                    <i class="ri-draft-line mr-2"></i>Borradores ({{ $drafts->count() }})
                </a>
            </li>
            <li class="mr-2">
                <a href="#" class="inline-flex items-center justify-center p-4 border-b-2 border-blue-500 text-blue-600 rounded-t-lg group font-semibold" data-tab="scheduled">
