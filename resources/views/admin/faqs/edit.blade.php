...
<div class="bg-white p-8 rounded-xl shadow-lg">
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-primary-600 mb-2">Editar Pregunta Frecuente</h1>
        <p class="text-sm text-gray-500">Modifica la pregunta frecuente seleccionada.</p>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea id="answer" name="answer" rows="6"
                          ...
                          placeholder="Escribe la respuesta..." required>{{ old('answer', $faq->answer) }}</textarea>
                @error('answer')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
