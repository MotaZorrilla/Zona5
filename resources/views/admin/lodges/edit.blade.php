    ...
    <div class="bg-white p-6 rounded-lg shadow-sm">
        <form action="{{ route('admin.lodges.update', $lodge) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="valley" id="valley" value="{{ $lodge->valley }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" required>
            </div>
            <div class="flex justify-end">
                ...
                <button type="submit" class="bg-primary-500 hover:bg-primary-600 text-white font-bold py-2 px-4 rounded-lg shadow-md">Actualizar</button>
            </div>
        </form>
    </div>
@endsection
