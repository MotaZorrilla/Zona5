    ...
    <div class="bg-white p-6 rounded-lg shadow-sm">
        <form action="{{ route('admin.lodges.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="valley" id="valley" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" required>
            </div>
