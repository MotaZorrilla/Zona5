...
@section('title', 'Mensajes Eliminados')
...
<div class="bg-white p-6 rounded-xl shadow-lg">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Mensajes Eliminados</h1>
            <p class="text-sm text-gray-500 mt-1">Lista de mensajes eliminados (soft delete).</p>
        </div>
    ...
    <div class="bg-gray-50 p-4 rounded-lg mb-6">
        <form method="GET" action="{{ route('admin.messages.deleted') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <!-- Search -->
            <div>
            ...
            <div class="flex items-end">
                <div class="w-full flex space-x-2">
                    ...
                    <a href="{{ route('admin.messages.deleted') }}" class="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded-lg shadow-md transition-colors">
                        Limpiar
                    </a>
                </div>
            </div>
        ...
        <table class="min-w-full divide-y divide-gray-200 bg-white">
            <thead class="bg-primary-500">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wider">Fecha Eliminado</th>
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($messages as $message)
                    <tr class="odd:bg-white even:bg-primary-50 hover:bg-primary-100 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $message->deleted_at ? $message->deleted_at->diffForHumans() : 'N/A' }}</td>
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-12 whitespace-nowrap text-center">
                            <div class="text-center">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900">No se encontraron mensajes eliminados</h3>
                                <p class="mt-1 text-sm text-gray-500">Tu papelera está vacía.</p>
                                <div class="mt-6">
