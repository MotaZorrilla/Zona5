...
<div class="flex h-[calc(100vh-150px)] bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl shadow-xl overflow-hidden border-gray-10">
    ...
    <aside class="w-72 bg-gradient-to-b from-indigo-700 to-purple-800 text-white p-5 flex-shrink-0 shadow-lg">
        ...
        <div class="mb-6">
            <a href="{{ route('admin.messages.create') }}" class="w-full flex items-center justify-center bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-bold py-4 px-5 rounded-xl shadow-lg transition-all transform hover:scale-105 duration-30 flex items-center gap-2">
        ...
        <nav class="space-y-1 mt-6">
            <a href="{{ route('admin.messages.index') }}" class="flex items-center px-4 py-3 text-white font-semibold bg-indigo-600 rounded-xl mb-1 transition-all duration-300 hover:bg-indigo-500 shadow-md">
            ...
            <a href="#" class="flex items-center px-4 py-3 text-indigo-10 hover:bg-indigo-600 rounded-xl transition-all duration-300 hover:text-white group">
    ...
    <div class="w-2/5 border-r border-gray-200 flex flex-col bg-white shadow-inner">
        <div class="p-5 border-b border-gray-100 bg-gradient-to-r from-white to-indigo-50 sticky top-0 bg-white z-10 shadow-sm">
            <h1 class="text-2xl font-bold text-indigo-800 flex items-center gap-2">
                <i class="ri-inbox-line"></i> Entrada
            </h1>
            <div class="relative mt-4">
                <i class="ri-search-line absolute top-1/2 -translate-y-1/2 left-3 text-gray-400 text-lg"></i>
                <input type="search" name="search" placeholder="Buscar en mensajes..." class="w-full bg-gray-50 border-2 border-gray-200 rounded-xl py-3 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-40 transition-all shadow-sm focus:shadow-md" />
            </div>
        </div>
        <div class="overflow-y-auto flex-grow">
            ...
            @empty
                <div class="p-10 text-center h-full flex flex-col justify-center items-center">
                    ...
                    <h3 class="mt-2 text-xl font-bold text-gray-70">Bandeja de entrada vacía</h3>
                    <p class="mt-1 text-gray-500">No tienes mensajes nuevos.</p>
                </div>
            @endforelse
        </div>
