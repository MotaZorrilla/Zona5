    ...
    <aside class="w-72 bg-gradient-to-b from-indigo-700 to-purple-800 text-white p-5 flex-shrink-0 shadow-lg">
        <div class="mb-8">
            <h2 class="text-2xl font-bold flex items-center gap-2">
                <i class="ri-user-line text-xl"></i> Administración
            </h2>
        </div>
        
        <div class="mb-6">
            <a href="{{ route('admin.users.create') }}" class="w-full flex items-center justify-center bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-bold py-4 px-5 rounded-xl shadow-lg transition-all transform hover:scale-105 duration-300 flex items-center gap-2">
        ...
        <nav class="space-y-1 mt-6">
            <a href="{{ route('admin.users.index') }}" class="flex items-center px-4 py-3 text-white font-semibold bg-indigo-60 rounded-xl mb-1 transition-all duration-300 hover:bg-indigo-500 shadow-md">
                <i class="ri-user-line mr-3 text-xl"></i>
                <span>Miembros</span>
            </a>
            <a href="{{ route('admin.lodges.index') }}" class="flex items-center px-4 py-3 text-indigo-100 hover:bg-indigo-600 rounded-xl transition-all duration-300 hover:text-white group">
                <i class="ri-building-2-line mr-3 text-xl group-hover:text-blue-300 transition-colors"></i>
                <span>Logias</span>
            </a>
